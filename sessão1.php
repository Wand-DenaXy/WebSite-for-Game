...
$_SESSION["data"] = "27/01/2005";
$_SESSION["nome"] = "MIGUELLL";
...
class Produto
{
    ...
    public function __construct(public $cp, public $nome, public $prec, public $quant,public $desc,public $prod) {
        $this->$nome = $nome;
        $this->$cp = $cp;
        $this->$quant = $quant;
        $this->$prec = $prec;
...
$prod = new Produto(1,"bananas","1.53%","10kg","Banana Importada",1);
?>
<!DOCTYPE html>
<html lang="pt">
<head>
